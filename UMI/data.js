...
window.BSU_DATA = {
  ...
  "movie_brain": {
    ...
    "subtitle": "A real person watched a 10-second clip of Friends (picture, sound, and dialogue) inside an fMRI scanner that recorded their brain. We then asked an AI model to predict that brain response from the very same clip. Top brain: what the person's brain actually did. Bottom brain: what the model predicted, for a clip it was never trained on. Both light up in step with the video as it plays (each map is a snapshot of the whole brain at that moment).",
